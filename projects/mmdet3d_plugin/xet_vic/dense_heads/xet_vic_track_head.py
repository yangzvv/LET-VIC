...
class XETVICBEVFormerTrackHead(DETRHead):
    """Head of Detr3D.
    Args:
    ...
    def __init__(self,
        ...
        super(XETVICBEVFormerTrackHead, self).__init__(
    ...
    def get_bev_features(self, mmdl_mlvl_feats, mmdl_metas, prev_bev=None):
        bs = mmdl_mlvl_feats[0][0].size(0)
        dtype = mmdl_mlvl_feats[0][0].dtype
