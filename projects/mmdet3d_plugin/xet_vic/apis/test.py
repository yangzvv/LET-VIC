    ...
    for i, data in enumerate(data_loader):
        with torch.no_grad():
            ...
            if eval_planning:
                ...
                planning_metrics(pred_sdc_traj[:, :planning_steps, :2], sdc_planning[0][0,:, :planning_steps, :2], sdc_planning_mask[0][0,:, :planning_steps, :2], segmentation[0][:, 1:planning_steps+1])
