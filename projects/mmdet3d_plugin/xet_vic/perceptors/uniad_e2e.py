...
class UniAD(UniADTrack):
    ...
    def forward_train(self,
        ...
        if self.with_seg_head:          
            losses_seg, outs_seg = self.seg_head.forward_train(bev_embed, img_metas,
                                                          gt_lane_labels, gt_lane_bboxes, gt_lane_masks, veh2inf_rt=veh2inf_rt)
    ...
    def forward_test(self,
        ...
        result_track = self.simple_test_track(img, l2g_t, l2g_r_mat, img_metas, timestamp, veh2inf_rt)
