...
use_pc_inf=False
input_modality = dict(
    use_camera=use_camera, use_lidar=use_lidar, use_inf=False, use_radar=False, use_map=False, use_external=True
)
_dim_ = 256
_pos_dim_ = _dim_ // 2
_ffn_dim_ = _dim_ * 2
...
data_root = "./datasets/V2X-Sim-full-id1/"
info_root = "./data/infos/V2X-Sim-full-id1/"
...
train_pipeline = [
    ...
    dict(
        type = 'XETVICV2XSimLoadMultiViewPointsFromFile',
        coord_type='LIDAR',
        load_dim=5,
        use_dim=5,
