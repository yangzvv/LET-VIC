...
use_pc_inf=True
input_modality = dict(
    use_camera=use_camera, use_lidar=use_lidar, use_radar=False, use_map=False, use_external=True
)
_dim_ = 256
_pos_dim_ = _dim_ // 2
_ffn_dim_ = _dim_ * 2
...
dataset_type = "XETVICSPDDataset"
data_root = "./datasets/V2X-Seq-SPD-2Hz-O-Example/cooperative/"
info_root = "./data/infos/V2X-Seq-SPD-2Hz-O-Example/cooperative/"
...
load_from = "checkpoints/bevformer_r101_dcn_24ep.pth"
