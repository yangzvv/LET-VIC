...
model = dict(
    ...
    ##pc backbone  https://github.com/AIR-THU/DAIR-V2X/blob/main/configs/vic3d/early-fusion-pointcloud/pointpillars/trainval_config.py
    voxel_layer=dict(
        max_num_points=100, point_cloud_range=point_cloud_range, voxel_size=voxel_size, max_voxels=(16000, 40000)
    ),
    voxel_layer_inf=dict(
        max_num_points=100, point_cloud_range=point_cloud_range_inf, voxel_size=voxel_size, max_voxels=(16000, 40000)
    ),
    voxel_encoder=dict(
...
dataset_type = "VICSPDE2EDataset"
data_root = "./datasets/V2X-Seq-SPD-10Hz-O/cooperative/"
info_root = "./data/infos/V2X-Seq-SPD-10Hz-O/cooperative/"
...
train_pipeline = [
    ...
    dict(
        ...
        type = 'LoadMultiViewPointsFromFile_E2E',
        coord_type='LIDAR',
        load_dim=5,
        use_dim=5,
    ...
    dict(type="DefaultFormatBundle3D_VIC", class_names=class_names),
    dict(
        ...
        meta_keys=(
            'pc_filename', 'ori_shape', 'img_shape', 'lidar2img', 'depth2img', 'cam2img', 'pad_shape',
            'scale_factor', 'flip', 'pcd_horizontal_flip',
            'pcd_vertical_flip', 'box_mode_3d', 'box_type_3d',
            'img_norm_cfg', 'pcd_trans', 'sample_idx', 'prev_idx', 'next_idx',
            'pcd_scale_factor', 'pcd_rotation', 'pts_filename',
            'transformation_3d_flow', 'scene_token', 'can_bus', "timestamps"
            )
    ),
]
test_pipeline = [
...
#                 ],
#             meta_keys=(
#                 'pc_filename', 'ori_shape', 'img_shape', 'lidar2img',
