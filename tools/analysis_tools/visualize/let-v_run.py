...
if __name__ == '__main__':
    ...
    parser.add_argument('--predroot', default='output/results-let-v.pkl', help='Path to results.pkl')
    parser.add_argument('--out_folder', default='viz/results-let-v/', help='Output folder path')
    parser.add_argument('--demo_video', default='mini_val_final.avi', help='Demo video name')
    parser.add_argument('--project_to_cam', default=False, help='Project to cam (default: False)')
    parser.add_argument('--dataroot', default='datasets/V2X-Seq-SPD-10Hz-O/vehicle-side', help='path to data')
