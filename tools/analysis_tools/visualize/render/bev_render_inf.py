...
class VICTrackLidarPointCloud(PointCloud):
    ...
    def _render_helper(self,
        ...
        ax.scatter(points[0, :], points[1, :], c='black', s=marker_size * 5)
...
class BEVRender(BaseRender):
    ...
    def set_plot_cfg(self):
        self.axes.set_xlim([0, 2 * self.margin])
    ...
    def render_pred_map_data(self, predicted_map_seg):
        ...
        self.axes.imshow(rendered_map, alpha=0.6,
                         interpolation='nearest', extent=(0, 102.4, -51.2, 51.2))
